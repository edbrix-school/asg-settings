...
public class DocumentService {
    ...
    @Autowired
    GlobalModuleMasterRepository globalModuleMasterRepository;
...
//        System.out.println("Base query = "+baseSql);
...
//        System.out.println("sorted sql = "+sortedSql);
...
//        System.out.println("Final query without params = "+finalSql);
//        System.out.println("Pagination params = " + params);
...
//        System.out.println("build where clause for searchable fields");
//        fields.forEach(f -> System.out.println("   " + f));
    ...
    public Map<String, Object> listDocuments(String docId, FilterRequestDto request, Pageable pageable) {
        ...
        String isDeleted = resolveIsDeleted(request);
        List<FilterDto> filters = resolveFilters(request);

        RawSearchResult raw = search(docId, filters, operator, pageable, isDeleted,
